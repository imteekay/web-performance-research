...
| —             | CSR                                         | SSR                                                             | Static SSR                                                      | SSR with Hydration                                           | CSR with Prerendering                            |
| ------------- | ------------------------------------------- | --------------------------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------ |
| **Overview**  | Rendering and booting is done on the client | The client requests pages and the server responds with the HTML | Page is prerendered to static HTML at build time. JS is removed | The server prerenders pages. The app is booted on the client | Page is prerendered to static HTML at build time |
| **Rendering** | JS/DOM                                      | Dynamic HTML                                                    | Static HTML                                                     | Dynamic HTML + JS/DOM                                        | Partial Static HTML, then JS/DOM                 |
| **Pros**      | Fast TTFB, flexible                         | Fast FCP, TTI                                                   | Fast TTFB, FCP, and TTI                                         | Flexible                                                     | Fast TTFB, flexible                              |
| **Cons**      | TTI >>> FCP                                 | Slow TTFB, Inflexible                                           | Inflexible, Hydration                                           | Slow TTFB, TTI                                               | TTI > FCP                                        |
